...
const AddFournisseurPage = ({ navigation }) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <TouchableOpacity style={styles.backButton} onPress={() => navigation.navigate('FournisseursPage')}>
        <Ionicons name="arrow-back" size={24} color="#000" />
      </TouchableOpacity>
      
      <Text style={styles.title}>Ajout Fournisseurs</Text>
      <View style={styles.formContainer}>
        ...
        <TextInput style={styles.input} placeholder="saisir" value={marchandise} onChangeText={setMarchandise} />
        ...
        <TouchableOpacity style={styles.submitButton} onPress={() => navigation.navigate('FournisseursPage')}>
